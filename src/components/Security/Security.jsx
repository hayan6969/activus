...
export default function Security() {
  ...
  const divStyle = " rounded-2xl h-full w-full overflow-hidden pointer-events-none md:pointer-events-auto bg-white ";

  return (
    <section className=" sectionCS h-fit md:h-screen w-full stickyScrol overflow-hidden site-bg ">
     <div className={"bg-white rounded-2xl m-4 md:mx-24"}>
     <BlurIn
        word={trans('heading')}
        className={" text-4xl sm:text-6xl md:text-7xl font-bold bg green-300 py-4 "}
        id={23}
      />
      <div className="  h-fit w-full grid place-items-center overflow-hidden ">
        {/* mobile  */}
